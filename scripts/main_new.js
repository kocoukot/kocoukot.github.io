...
this.window.addEventListener("scroll", () => {
  ...
  // Проходимся по всем секциям на странице
  sections.forEach((section) => {
    ...
    // Проверяем, находится ли секция на видимой части экрана
    if (scrollPosition >= sectionTop && scrollPosition < sectionBottom) {
      // Если да, то добавляем класс `active` для этой секции
...
const our_steps_section = function (e) {
  function t(t) {
    ...
    return (
      r && ((n.typingController = new s(r)), n.typingController.forceClear()),
      n.startSwapLines(),
      n
    );
  }
    ...
    (t.prototype.processCanvas = function () {
      ...
      if (this.canvasContainer) {
        ...
        new IntersectionObserver(function (e, t) {
          var n;
          o = null === (n = e[0]) || void 0 === n ? void 0 : n.isIntersecting;
...
(Ll = location.hash),
  (sections_list = [
    { current: "" === Ll || "#welcome" === Ll, screen: our_steps_section },
